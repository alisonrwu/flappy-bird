...
public class Tube {
    ...
    private static final int RANGE = 130; //[0,RANGE)
    ...
    public Tube(float x){
        ...
        botTube = new Texture("bottomtube.png"); //TODO: reuse same texture, rather than new for 4 tubes
        rand = new Random();

        posTopTube = new Vector2(x, rand.nextInt(RANGE) + TUBE_GAP + LOWEST_OPENING);
    ...
    public void reposition(float x){
        posTopTube.set(x, rand.nextInt(RANGE) + TUBE_GAP + LOWEST_OPENING);
